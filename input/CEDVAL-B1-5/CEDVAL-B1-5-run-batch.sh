...
inputFilename="CEDVAL-B1-5"$inputFileExtension
inputFileTemplateFilename="CEDVAL-B1-5-template"$inputFileExtension
...
resultsFolderName=$outputDir/"CEDVAL-B1-5"
...
for planeSweepDirIdx in ${!sweepDirections[@]}; do
        ...
        for lineSweepDirIdx in ${!sweepDirections[@]}; do
            ...
            # Header 
            echo $'\n\n' >> $logFileName
            echo "================= CEDVAL B1-5 ================= " | tee -a $logFileName

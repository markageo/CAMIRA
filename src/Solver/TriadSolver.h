...
public:
                             ...
                             const FieldData<Tensor1D> &lineConstants )
    {
        ...
        floatType bU = ( lineConstants.U[X](igU)  
        ...
        floatType bV = ( lineConstants.U[Y](igV)
        ...
        floatType bW = ( lineConstants.U[Z](igW)
        ...
        floatType bP = lineConstants.P(ig)

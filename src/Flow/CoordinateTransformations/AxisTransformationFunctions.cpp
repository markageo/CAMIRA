...
namespace 
{
    ...
    void ReverseMesh(std::vector< MeshSegment > &meshSegments)
    {
                       ...
                       const AxisTransformationMap &axisTransformation )
    {
        ...
        EnumVector<Axis, std::vector<MeshSegment> > userMeshSegments = inputData.meshSegments;
                            ...
                            const AxisTransformationMap &axisTransformation )
    {
        ...
        // Blocks
        for ( SolidBlockData &solidBlock : inputData.geometryData.solidBlocks ) {
        ...
        // Spheres
        for ( SolidSphereData &solidSphere : inputData.geometryData.solidSpheres ) {
            solidSphere.centerPosition = TransformPositionArray3ToCode( solidSphere.centerPosition, axisTransformation );
        }

        // STL files
        for ( STLGeometryData &stlGeometryData : inputData.geometryData.stlGeometries ) {

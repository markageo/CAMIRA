                                         ...
                                         const BoundaryConditionData::Patches &bcDataPatches )
{
    EnumFor<BoundaryPatches>( [&] (BoundaryPatches::ENUMDATA bp) {
        ...
        AddFaceInterpolatedBoundarySources(momentumEquation.BPBoundary, pressureField, mesh, bcDataPatches, bp);
                                           ...
                                           const EnumVector<Axis, BoundaryConditionData::Patches > &velocityBoundaryConditions )
{
    EnumFor<BoundaryPatches>( [&] (BoundaryPatches::ENUMDATA bp) {
        ...
        AddFaceInterpolatedBoundarySources( continuityEquation.BUBoundary, velocityFields[axis], mesh, velocityBoundaryConditions[axis], bp);
    } );
}
                           ...
                           const BoundaryConditionData &bcData )
{
    ...
    EnumFor<Axis>( [&] (Axis::ENUMDATA axis) {
        ...
        AddMomentumPressureBoundarySources(fvCoeffs.Mom[axis], fields.P, fvCoeffs.rho, mesh, bcData.fields.P);
    ...
    AddContinuityVelocityBoundarySources( fvCoeffs.Cont, fields.U, mesh, bcData.fields.U );
